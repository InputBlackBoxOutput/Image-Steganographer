...
extract.addEventListener('click', function () {
    ...
    if (/\/blank/g.test(sink_image.src))
        validationResult = "Please open an image";
...
function extractDataFromImage() {
    ...
    if ('Ÿ' == msg[0] && 'Ÿ' == msg[1] && 'Ÿ' == msg[2]) {
        ...
        extract_done.innerText = "Message extracted from the image";
...
document.getElementById('extract-open').addEventListener('click', function () { reset(); openImage(0); });
